...
class CreateTbProjetoRouanetTesteTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('tb_projeto_rouanet_teste', function (Blueprint $table) {
            $table->unsignedInteger('id_projeto')->index('tb_projeto_rouanet_id_projeto_foreign');
            $table->string('pronac', 191)->index('idx_pronac');
            $table->string('ano_projeto', 191);
            $table->string('nome', 191)->index('nome_3');
            ...
            $table->index(['nome', 'resumo'], 'nome_2');
            $table->index(['nome', 'segmento'], 'nome');
            $table->index(['area', 'uf', 'municipio', 'nome', 'segmento'], 'filtros');
            $table->index(['nome', 'resumo', 'objetivo'], 'nome_4');
        });
    }
